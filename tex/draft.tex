...
\section{Supersymmetry}
    ...
    \quad + \quad
    \feynmandiagram [baseline={(current bounding box.center)}, layered layout, medium, horizontal=b to c] {
        a -- [scalar] b,
        b -- [charged scalar, half left] c,
        c -- [charged scalar, half left] b,
        c -- [scalar] d,
    };
    \quad = \quad 0 \quad
    \caption{Caption!\fxnote{cite something}}
    ...
    \noindent \begin{equation}
        \delta \mHiggs^2 = \frac{3Y^2}{8\pi^2}\left(m_{\sfermion}^2 - m_{\f}^2 \right)\ln(\Lambda^2/m_{\sfermion}^2).
...
\section{Experimental Viability of Natural SUSY}
    ...
    Fig.~\ref{atlas_susy_searches} summarizes limits on SUSY models from ATLAS searches. CMS limits are generally similar\fxnote{make sure this is true}, but a recent plot was not available.   
