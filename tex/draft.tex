...
\section{The Standard Model} \label{SM}
    ...
    \includegraphics[width=0.8\textwidth]{images/loop_diagrams}
...
\section{Supersymmetry}
    ...
    \noindent \begin{figure}[htbp] \begin{center}
    \includegraphics[width=0.8\textwidth]{images/exact_susy_correction}
    \caption{Caption!\fxnote{cite something}}
...
\section{The CMS Detector}\fxnote{Add pictures of everything}
    \subsection{Overview}
        ...
        \noindent \begin{figure}[htbp] \begin{center}
        \includegraphics[width=0.8\textwidth]{images/cms}
            \caption{CMS}
        \label{cms}
        \end{center} \end{figure}
...
\section{LHC Searches for Long-lived Particles}
    ...
    \subsection{Overview}
        ...
        \noindent \begin{figure}[htbp] \begin{center}
        \includegraphics[width=0.8\textwidth]{images/jamie_cartoon}
    ...
    \subsection{Displaced Vertices}
        ...
        \noindent \begin{figure}[htbp] \begin{center}
        \includegraphics[width=0.8\textwidth]{images/displaced_process_diagram}
        \caption{Process.}
        ...
        \noindent \begin{figure}[htbp] \begin{center}
        \includegraphics[width=0.8\textwidth]{images/material_map}
        ...
        \noindent \begin{figure}[htbp] \begin{center}
        \includegraphics[width=0.8\textwidth]{images/displaced_limit}
        \caption{Limit.}
    ...
    \subsection{Disappearing Tracks}
        ...
        The authors consider two signal processes, both shown in Fig.\ref{disappearing_processes}: (1) electroweak gaugino production resulting in a disappearing track, an ISR jet, and MET and (2) gluino pair production resulting in a disappearing track, four jets, and MET\fxnote{add diagrams}. Process (1) could be the only gaugino production mode at the LHC if the gluino mass is kinematically unaccessable\fxnote{why?}, but process (2), which leads to chargino production in cascade decays, will be dominant if the gluino mass is within reach.

        \noindent \begin{figure}[htbp] \begin{center}
        \includegraphics[width=0.8\textwidth]{images/disappearing_processes}
        \caption{Processes.}
        ...
        \noindent \begin{figure}[htbp] \begin{center}
        \includegraphics[width=0.8\textwidth]{images/disappearing_limits}
        \caption{Limits.}
    ...
    \subsection{Stopped Particles}
        ...
        \noindent \begin{figure}[htbp] \begin{center}
        \includegraphics[width=0.8\textwidth]{images/stopped_muon_differentiation}
        ...
        \noindent \begin{figure}[htbp] \begin{center}
        \includegraphics[width=0.8\textwidth]{images/stopped_limits}
    ...
    \subsection{Heavy Stable Charged Particles}
        ...
        \noindent \begin{figure}[htbp] \begin{center}
        \includegraphics[width=0.8\textwidth]{images/hscp_dedx}
        ...
        \noindent \begin{figure}[htbp] \begin{center}
        \includegraphics[width=0.8\textwidth]{images/hscp_limits}
            \caption{Limits.\fxnote{cite analysis}}
        \label{hscp_limits}
        \end{center} \end{figure}
